...
sp500_wiki <- read_html("scrapedpage.html")
...
#run this script only if you want to save the data
#save the data as csv into work directory, run getwd() to see where it is saved
